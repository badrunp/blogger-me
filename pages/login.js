        ...
        <>
            <GuestLayout title="Sign In">
                <div className="flex flex-row items-center justify-start space-x-2">
                    ...
                    <h1 className="block text-gray-600 font-semibold text-xl">Sign In your account</h1>
                </div>
                ...
                <div className="mt-6">
                    <form>
                        ...
                        <Button type="button" className="bg-blue-500 text-white font-medium text-sm py-3 px-6 hover:bg-blue-600 shadow-sm focus:ring-2 border-transparent focus:ring-offset-1">Sign In</Button>
