        ...
        <>
            <Layout title="Blogs">
                <Container className="md:container px-0 md:px-4">
                    <div className="w-full py-8 sm:py-14 flex flex-col items-strart justify-start space-y-14 px-6 md:px-8 lg:px-12">
                        <div className="text-left">
                            <h1 className="block text-4xl text-gray-700 font-bold font-sans">All Posts</h1>
                        </div>
